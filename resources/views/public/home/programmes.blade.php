...
@section('meta')
    <meta name="description"
        content="Explorez les programmes offerts par l'ASDJ au Burkina Faso. Découvrez comment nous soutenons la jeunesse à travers nos initiatives et nos projets de développement.">
    <meta name="keywords" content="programmes jeunesse, initiatives jeunes, projets de développement, ASDJ Burkina Faso, asdj, ASDJ">
@endsection
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <a href="{{ route('home.programmes') . '#pst' }}" class="btn btn-primary float-bottom">savoir
                                plus</a>
                        </div>
                    </div>
                </div>
